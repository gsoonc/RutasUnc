...
import 'package:rutasunc/CreateUserPage.dart';
import 'package:rutasunc/Maps.dart';
        ...
        SignInButton(Buttons.Google, onPressed: () async {
          ...
          if (FirebaseAuth.instance.currentUser != null) {
            Navigator.pushAndRemoveUntil(
                context, MaterialPageRoute(builder: (context) => MapScreen()), (Route<dynamic> route) => false);
          }
        }),
        Offstage(
  ...
  Future<UserCredential?> login(String email, String passwd) async {
    try {
      ...
      if (e.code == 'user-not-found') {
        ...
        setState(() {
          error = "Error al iniciar sesión: Contraseña o usuario invalido";
        });
      } else {
        setState(() {
          error = "Error al iniciar sesión: ${e.code}";
        });
      }
      return null;
    }
